...
export default function getSpeed(speed) {
  ...
  const testes = [
    [value => value > value1864cmn, othvalue = value1864cmn],
    [value => value > value1746cmn, othvalue = value1746cmn],
    [value => value > value1628cmn, othvalue = value1628cmn],
    [value => value > value1510cmn, othvalue = value1510cmn],
    [value => value > value1392cmn, othvalue = value1392cmn],
    [value => value > value1274cmn, othvalue = value1274cmn],
    [value => value > value1156cmn, othvalue = value1156cmn],
    [value => value > value1038cmn, othvalue = value1038cmn],
    [value => value > value920cmn,  othvalue = value920cmn],
    [value => value === value920cmn,  othvalue = 0],
  ];
  let [_, othvalue] = testes.find(([testando]) => testando(speed));
